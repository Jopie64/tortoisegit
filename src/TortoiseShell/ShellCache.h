...
public:
	...
	ShellCache()
	{
		...
		menulayoutlow = CRegStdWORD(_T("Software\\TortoiseGit\\ContextMenuEntries"),		(DWORD)((MENUSYNC|MENUCREATEREPOS|MENUCLONE|MENUCOMMIT)&0xFFFFFFFF));
		menulayouthigh = CRegStdWORD(_T("Software\\TortoiseGit\\ContextMenuEntrieshigh"),	(DWORD)((MENUSYNC|MENUCREATEREPOS|MENUCLONE|MENUCOMMIT)>>32));
